...
public class DatabaseInitializer {
    ...
    public void init() throws IOException, URISyntaxException {
        ...
        userRepository.save(new User("user", "User1", "User2", "user@example.org", passwordEncoder.encode("pass"), "USER"));
        User admin = new User("admin", "Admin2", "Admin2", "admin@example.org", passwordEncoder.encode("adminpass"), "USER", "ADMIN");
